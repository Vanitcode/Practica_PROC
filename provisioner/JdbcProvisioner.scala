...
object JdbcProvisioner {
  ...
  def main(args: Array[String]) {
    ...
    //Borramos tabla porque he duplicado datos
      statement.execute("Truncate table user_metadata")
      ...
      statement.execute("INSERT INTO user_metadata (id, name, email, quota) VALUES ('00000000-0000-0000-0000-000000000013', 'milagros', 'milagros@gmail.com', 20000)")
